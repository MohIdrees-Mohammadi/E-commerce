        ...
        <div className='w-[20%] '>
          ...
          <div className='bg-white sticky top-22  m-10 p-5 rounded-2xl border border-gray-100 shadow-sm'>
            ...
            <div className='mt-10 p-2 flex flex-col gap-4'>
              <span className='font-semibold'>Price Range: ${priceRange[0]} - {priceRange[1]}</span>
              <Slider value={priceRange} onValueChange={(value) => setPriceRange(value)} min={0} max={100} step={1} />
            </div>

            <button onClick={handleReset} className='mt-10 bg-red-100 border border-red-300 px-4 py-2 rounded-md w-full'>Reset Filters</button>
          </div>
        </div>
