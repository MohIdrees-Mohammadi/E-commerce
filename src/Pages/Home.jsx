    ...
    <>
      ...
      <section className="bg-[#c2b2a233] pb-25">
        <div className="flex flex-col justify-center items-center">
          <h1 className="pb-2 pt-10 text-[48px] font-family-serif font-bold">Our Trusted Partners</h1>
        ...
        <div className="flex  flex-col items-center gap-5"> 
          <h1 className="text-[#8A5C67] text-[18px] font-family-serif">Interested in partnering with us?</h1>
          <Link to="/contact">
